...
8. Dice Rolling
Create a program which simulates rolling a collection of dice for a table top game. The user should be able to keep rolling until they choose to exit. You can implement this as a menu, or through a special input the user must enter.
